class TestDrive {
    public static void main(String[] args) throws InterruptedException {
        ...
        Burger chineseBurger = store.orderBurger("Chinese Burger");
        Burger americanBurger = store.orderBurger("American Burger");
        Burger russianBurger = store.orderBurger("Russian Burger");
    }
}
...
class ChineseBurger extends Burger {
    ...
    ChineseBurger(String name) { super(name); }

}

class AmericanBurger extends Burger {

    AmericanBurger(String name) { super(name); }
}

class RussianBurger extends Burger {

    RussianBurger(String name) { super(name); }
}